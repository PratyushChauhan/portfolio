...
### Done
- [x] robots.txt — live at `/portfolio/robots.txt`
- [x] sitemap.xml — live at `/portfolio/sitemap.xml`
- [x] rss.xml — live at `/portfolio/rss.xml`
- [x] Schema.org structured data (`Person`, `BlogPosting`)
- [x] Canonical URLs, OG tags, Twitter Cards
- [x] Semantic heading hierarchy (`h1 → h2 → h3`)
- [x] Font preconnect, lazy loading, mobile viewport
...
- [ ] Newsletter/CTA section on blog index
- [ ] Image `alt` text audit across portfolio
