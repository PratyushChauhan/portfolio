...
Reference full template: `/home/cipher/dev/portfolio/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/cipher/dev/portfolio/.claude/get-shit-done/templates/state.md`.
