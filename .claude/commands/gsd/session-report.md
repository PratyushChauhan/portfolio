...
<execution_context>
@/home/cipher/dev/portfolio/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/home/cipher/dev/portfolio/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
